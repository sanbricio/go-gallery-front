        ...
        <div *ngIf="user">
          <form [formGroup]="profileForm" (ngSubmit)="onSubmit()" class="profile-form">
            ...
            <div class="form-group">
              ...
              <div class="hint-text">Leave blank to keep your current password</div>
            </div>
            ...
            <div class="form-actions">
              ...
              >
                <app-loading-spinner *ngIf="updateLoading" [size]="24"></app-loading-spinner>
          ...
          <div class="danger-zone">
            ...
            <div *ngIf="!showDeleteConfirm">
              <p>This action cannot be undone. This will permanently delete your account and all your images.</p>
              <button
                class="btn-danger"
                (click)="requestDeleteAccount()"
                [disabled]="requestDeleteLoading"
              >
                <app-loading-spinner *ngIf="requestDeleteLoading" [size]="24"></app-loading-spinner>
                <span *ngIf="!requestDeleteLoading">Delete Account</span>
              </button>
            </div>
            
            <div *ngIf="showDeleteConfirm" class="delete-confirm">
              <p>A verification code has been sent to your email. Enter the code and your password to confirm deletion.</p>
              
              <form [formGroup]="deleteForm" (ngSubmit)="confirmDeleteAccount()" class="delete-form">
                <div class="form-group">
                  ...
                  >
                  <div *ngIf="deleteSubmitted && d['code'].errors" class="error-message">
                    <span *ngIf="d['code'].errors['required']">Verification code is required</span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  >
                  <div *ngIf="deleteSubmitted && d['password'].errors" class="error-message">
                    <span *ngIf="d['password'].errors['required']">Password is required</span>
                  </div>
                </div>
                ...
                <div class="form-actions delete-actions">
                  ...
                  >
                    <app-loading-spinner *ngIf="deleteLoading" [size]="24"></app-loading-spinner>

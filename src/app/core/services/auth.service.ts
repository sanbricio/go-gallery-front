...
export class AuthService {
  ...
  register(registerData: RegisterRequest): Observable<RegisterResponse> {
    return this.http
      .post<RegisterResponse>(`${this.apiUrl}/register`, registerData)
      .pipe(
        catchError((error) => {
          return throwError(() => error);
        })
  ...
  updateUser(userData: UpdateUserRequest): Observable<RegisterResponse> {
    return this.http
      .put<RegisterResponse>(`${this.apiUrl}/update`, userData)
      .pipe(
        tap((response) => {
  ...
  requestDeleteAccount(): Observable<RegisterResponse> {
    return this.http
      .post<RegisterResponse>(`${this.apiUrl}/request-delete`, {})
      .pipe(
        catchError((error) => {
          return throwError(() => error);
        })
  ...
  deleteAccount(deleteData: DeleteUserRequest): Observable<RegisterResponse> {
    return this.http
      .delete<RegisterResponse>(`${this.apiUrl}/delete`, { body: deleteData })
      .pipe(
        tap(() => {
          sessionStorage.removeItem("user");
          this.currentUserSubject.next(null);
  ...
  requestPasswordRecovery(payload: { email: string }) {
    return this.http.post(`${this.apiUrl}/request-recover`, payload);
  }
  ...
  recoverPassword(payload: {
    ...
    return this.http.post(`${this.apiUrl}/recover`, payload);
  }
}
